...
#include "farm_ai_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_FARM_AI_MODEL_NAME          "farm_ai"
#define AI_FARM_AI_ORIGIN_MODEL_NAME   "farm_ai_multiclass"

/******************************************************************************/
#define AI_FARM_AI_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FARM_AI_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FARM_AI_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FARM_AI_IN_NUM        (1)

AI_DEPRECATED
#define AI_FARM_AI_IN \
  ai_farm_ai_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FARM_AI_IN_SIZE { \
  AI_FARM_AI_IN_1_SIZE, \
}
#define AI_FARM_AI_IN_SIZE_BYTES { \
  AI_FARM_AI_IN_1_SIZE_BYTES, \
}
#define AI_FARM_AI_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FARM_AI_IN_1_CHANNEL     (4)
#define AI_FARM_AI_IN_1_SIZE        (4)
#define AI_FARM_AI_IN_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_FARM_AI_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FARM_AI_OUT \
  ai_farm_ai_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FARM_AI_OUT_SIZE { \
  AI_FARM_AI_OUT_1_SIZE, \
}
#define AI_FARM_AI_OUT_SIZE_BYTES { \
  AI_FARM_AI_OUT_1_SIZE_BYTES, \
}
#define AI_FARM_AI_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FARM_AI_OUT_1_CHANNEL     (4)
#define AI_FARM_AI_OUT_1_SIZE        (4)
#define AI_FARM_AI_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_FARM_AI_N_NODES (6)
 ...
 * @ref ai_farm_ai_create. Both the activations memory buffer 
 ...
 * using @ref ai_farm_ai_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_farm_ai_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_farm_ai_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FARM_AI_*
 * defines into file @ref farm_ai.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
